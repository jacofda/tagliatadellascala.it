...
@section('meta')
<title>Stand Scala dei Sapori di Primolano con tag: {{$tag->name}}</title>
<meta name="description" content="Stand Scala dei Sapori di Primolano con tag: {{$tag->name}}">
...
@section('title')
    <section class="page-section bg-dark-alfa-90">
        <div class="relative container align-left">
            <div class="row">
                <div class="col-md-8">
                    <h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Stands / {{$tag->name}}</h1>
