...
<title>Associazione Tagliata Della Scala Primolano</title>
    ...
    <meta property="og:url" content="{{url('associazione/chi-siamo')}}" />
    ...
    <meta property="og:image" content="{{asset('img/fb/associazione-tagliata-della-scala.jpg')}}" />
...
<script type="application/ld+json">
{
   ...
   "url":"{{url('/')}}",
   "logo":"{{asset('img/logo-footer.png')}}",
   "foundingDate":"2009",
   "founders":[
      {
         "@type":"Person",
...
@section('title')
    <section class="page-section bg-dark-alfa-70 parallax-3" data-background="{{asset('img/chisiamo.jpg')}}">
            ...
            <div class="row"> 
                ...
                <div class="col-md-4 mt-30">
                    <div class="mod-breadcrumbs font-alt align-right">
                        <a href="{{url('/')}}">Home</a>&nbsp;/&nbsp;<a href="{{url($sector->slug)}}"><span>La nostra associazione</span></a>
                    </div>  
                </div>
            </div>
        </div>
