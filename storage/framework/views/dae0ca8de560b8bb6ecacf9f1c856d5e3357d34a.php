...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-sm-12 ">
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $article->media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="file<?php echo e($file->id); ?>">
                            ...
                            <td style="text-align: center;">
                                <?php if($file->mime == 'image'): ?>
                                    <a class="image-popup" href="<?php echo e(asset('storage/articles/full/'.$file->filename)); ?>" >
                                        <img class="max100" src="<?php echo e(asset('storage/articles/display/'.$file->filename)); ?>">
                                    </a>
                                <?php endif; ?>
                            </td>
                            <td>
                                <form method="POST" action="<?php echo e(url('admin/media/delete')); ?>" class="deleteMedia">
                                    ...
                                    <input type="hidden" name="directory" value="articles">
                                    <input type="hidden" name="id" value="<?php echo e($file->id); ?>">
    ...
    <div class="text-center mt40">
        <a class="btn btn-primary" href="<?php echo e(url('admin/articoli')); ?>">Torna Agli Articoli</a><a class="btn btn-primary" href="<?php echo e($article->url); ?>">Vedi Articolo</a>
    </div>
...
<script>
        ...
        Dropzone.options.dropzoneForm = {
            ...
            sending: function(file, xhr, formData) {
                formData.append("mediable_id", "<?php echo e($article->id); ?>");
                formData.append("mediable_type", "App\\Article");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/479065.cloudwaysapps.com/kpdkwexcdb/public_html/resources/views/pages/articles/addMedia.blade.php ENDPATH**/ ?>