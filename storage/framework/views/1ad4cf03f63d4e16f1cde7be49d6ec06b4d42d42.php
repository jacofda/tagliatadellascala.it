...
<title>Tutte le foto dell'Associazione Tagliata Della Scala</title>
    ...
    <meta property="og:url" content="<?php echo e(url('gallerie/associazione')); ?>" />
    ...
    <meta property="og:image" content="<?php echo e(\App\Sector::find(2)->galleries()->latest()->first()->image_full); ?>" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/479065.cloudwaysapps.com/kpdkwexcdb/public_html/resources/views/pages/galleries/associazione.blade.php ENDPATH**/ ?>