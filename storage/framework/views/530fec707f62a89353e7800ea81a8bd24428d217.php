...
<title>Stand Scala dei Sapori di Primolano con tag: <?php echo e($tag->name); ?></title>
<meta name="description" content="Stand Scala dei Sapori di Primolano con tag: <?php echo e($tag->name); ?>">
...
<?php $__env->startSection('title'); ?>
    <section class="page-section bg-dark-alfa-90">
        <div class="relative container align-left">
            <div class="row">
                <div class="col-md-8">
                    <h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Stands / <?php echo e($tag->name); ?></h1>
                ...
                <div class="col-md-4 mt-30">
                    <div class="mod-breadcrumbs font-alt align-right">
                        ...
                        <span>Stands / <?php echo e($tag->name); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/479065.cloudwaysapps.com/kpdkwexcdb/public_html/resources/views/pages/articles/scala-tag.blade.php ENDPATH**/ ?>