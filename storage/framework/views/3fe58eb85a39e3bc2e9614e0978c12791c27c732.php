...
<title>Associazione Tagliata Della Scala | News / Gallerie / Foto / Eventi</title>
<meta name="description" content="Tutti i contenuti riguardanti l'associazione Tagliata Della Scala di Primolano" />
...
<?php $__env->startSection('title'); ?>
    <section class="page-section bg-dark-alfa-90">
        <div class="relative container align-left"> 
            <div class="row"> 
                <div class="col-md-8">
                    <h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Ass. Tagliata Della Scala</h1>
            ...
            <?php $__currentLoopData = $collection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-6 col-lg-6 mb-60 mb-xs-40">
                    ...
                    <div class="post-prev-title font-alt">
                        <a href="<?php echo e($content->url); ?>"><b><?php echo e($content->class); ?></b> - <?php echo e($content->name); ?></a>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/479065.cloudwaysapps.com/kpdkwexcdb/public_html/resources/views/pages/collections/associazione.blade.php ENDPATH**/ ?>