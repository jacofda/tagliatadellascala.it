    ...
    <div class="container relative">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <form  class="form contact-form" id="contact_form" role="form" method="POST" action="<?php echo e(route('password.request')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/479065.cloudwaysapps.com/kpdkwexcdb/public_html/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>